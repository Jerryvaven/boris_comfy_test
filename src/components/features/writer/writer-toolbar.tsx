...
export function WriterToolbar({
  ...
  return (
    <div className="bg-gray-950 border-b border-gray-700 px-2 py-4 flex items-center justify-between h-[90px] sticky top-0 z-10">
      {/* Left Section */}
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {showNewComicDropdown && (
            <div className="absolute top-full left-0 mt-2 bg-gray-800  rounded-md shadow-lg z-50 min-w-48">
              <button
                onClick={() => {
                  onNewComic();
