...
const CharacterInfoModal: React.FC<CharacterInfoModalProps> = ({ character, visible }) => {
    ...
    <div
      className={` w-[400px] bg-[var(--card-bg)] border border-[var(--border-color)]
        ...
        flex flex-col pointer-events-none ${
          visible ? "opacity-100 visible pointer-events-auto" : "opacity-0 invisible"
        }`}
    >
      {/* Arrow Pointer */}
      <div className="absolute top-[38%] -left-2 -translate-y-1/2">
        <div className="w-0 h-0 border-t-8 border-b-8 border-r-8 
